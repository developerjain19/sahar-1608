                                ...
                                ?>
                                        <li><span><img src="<?= base_url() ?>uploads/section/<?= $row['section_image'] ?>" class="product-img"></span>
                                            ...
                                            <div class="buttons-to-right">
                                                <a href="<?= base_url('update-section/' . encryptId($row['section_id'])) ?>" class="button btn-primary"><i class="fa fa-edit"></i></a>
                                                <a href="<?= base_url('section-list') ?>?BdID=<?= $row['section_id'] ?>" class="button btn-danger"><i class="fa fa-trash"></i></a>
                                            </div>
                                        </li>
