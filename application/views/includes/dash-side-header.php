    ...
    <div class="collapse" id="MobNav">
        <div class="goodup-dashboard-nav sticky-top">
            ...
            <div class="goodup-dashboard-inner dash-nav <?= sessionId('sahar') ? "" : "disable"; ?>">
                ...
                <div class="nav-head d-flex justify-content-between align-items-center border-top"><span>Add Sections</span>
                    <div id="multisection-toggle" class="fas fa-plus"></div>
                </div>
                <ul data-submenu-title="Add multisection" class="multisection">
